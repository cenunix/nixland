...
weather = requests.get("https://wttr.in/Alderwood_Manor?format=j1").json()
...
data['text'] = WEATHER_CODES[weather['current_condition'][0]['weatherCode']] + ' ' +extrachar+weather['current_condition'][0]['FeelsLikeF']+"°"
