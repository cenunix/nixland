...
, makeDesktopItem, gtk3, xdg-user-dirs, keybinder3, libnotify }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchzip {
    url =
      "https://github.com/AppFlowy-IO/appflowy/archive/275d0b2ac427a3b589be40c7f8553ea8e9f75e7e";
    hash = "";
    stripRoot = false;
  };
  ...
  buildInputs = [ gtk3 keybinder3 libnotify ];
  ...
  installPhase = ''
    ...
    cd AppFlowy-275d0b2ac427a3b589be40c7f8553ea8e9f75e7e/
